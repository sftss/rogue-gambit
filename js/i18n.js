...
const I18n = {
  ...
  messages: {
    en: {
      ...
      codex: {
        ...
        ability: 'ABILITY',
        howToPlay: 'HOW RUNS WORK',
        howToPlayBody: 'Build your army in Draft and Shop between battles. Defeats cost a life, and losing all lives ends the run. Win rounds to earn gold, buy pieces and relics, and outscale harder enemies.',
    ...
    fr: {
      ...
      codex: {
        ...
        ability: 'CAPACITE',
        howToPlay: 'COMMENT FONCTIONNE LA RUN',
        howToPlayBody: 'Entre les combats, tu renforces ton armee via le Draft et la Boutique. Chaque defaite te coute une vie, et perdre toutes tes vies met fin a la run. Gagne des manches pour obtenir de l\'or, acheter des pieces et des reliques, puis tenir face aux manches plus dures.',
  ...
  frPieceInfo: {
    pawn: { name: 'Pion', desc: 'Avance d\'1 case (2 au premier coup), capture en diagonale et promeut sur la derniere rangee.' },
    rook: { name: 'Tour', desc: 'Se deplace en ligne droite sur autant de cases que voulu. Excellente sur colonnes et lignes ouvertes.' },
    bishop: { name: 'Fou', desc: 'Se deplace en diagonale sur autant de cases que voulu. Reste sur la meme couleur toute la partie.' },
    knight: { name: 'Cavalier', desc: 'Se deplace en L et saute par-dessus les pieces. Tres fort dans les positions encombrees.' },
    queen: { name: 'Reine', desc: 'Combine les mouvements de la Tour et du Fou. Piece longue portee la plus polyvalente.' },
    king: { name: 'Roi', desc: 'Se deplace d\'1 case dans toutes les directions. Si ton Roi est detruit, tu perds le combat.' },
